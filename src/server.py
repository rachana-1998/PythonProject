...
def load_config(config_path="config.json"):
    """Load configuration from config.json for theme and layout preferences."""
    default_config = {"theme": "modern_blue", "layouts": ["title_slide", "content_slide", "chart_slide"]}
...
async def main():
    ...
    parser.add_argument("--folder-path", required=True, help="Path to save presentations and images")
    parser.add_argument("--theme", default="modern_blue",
   ...
   # theme = args.theme if args.theme in config.get("themes", ["modern_blue", "elegant_green"]) else config["theme"]
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "theme": {
                            "type": "string",
                            "description": "Theme for the presentation (e.g., modern_blue, elegant_green)",
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "theme": {
                            "type": "string",
                            "description": "Theme for image styling (e.g., modern_blue, elegant_green)",
                            "default": default_theme
                        }
                    },
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "presentation_name": {
                            "type": "string",
                            "description": "Name of the presentation to add the animation to",
                        },
                        "slide_index": {
                            "type": "number",
                            "description": "Index of the slide to animate (0-based)",
                        },
                        "effect": {
                            "type": "string",
                            "description": "Animation effect (e.g., fade, zoom)",
                            "default": "fade"
                        }
                    },
                    "required": ["presentation_name", "slide_index"],
                },
            ),
            types.Tool(
    ...
    async def handle_call_tool(
        ...
        elif name == "add-animation":
            presentation_name = arguments.get("presentation_name")
            slide_index = arguments.get("slide_index")
            effect = arguments.get("effect", "fade")

            if not all([presentation_name, slide_index is not None]):
                raise ValueError("Missing required arguments")
